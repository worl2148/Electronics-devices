...
# Alias to AWS_* names so existing imports (from config import AWS_ACCESS_KEY_ID, ...) still work
AWS_ACCESS_KEY_ID = CF_R2_ACCESS_KEY_ID
AWS_SECRET_ACCESS_KEY = CF_R2_SECRET_ACCESS_KEY
AWS_S3_BUCKET = CF_R2_BUCKET_NAME
AWS_REGION = 'auto'
...
# Storage Paths (same partition structure as AWS version)
