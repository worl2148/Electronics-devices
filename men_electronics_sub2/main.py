...
# Hardcoded subcategory URLs for Men's Electronics - Group 2 (Phone & Computing)
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/electronics/phone-cases/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/screen-protectors/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/tablet-cases/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/wallet-grip-stand/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/adapters/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/cables/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/chargers/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/power-banks/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/computer-accessories/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/gaming-accessories/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/fitness-tracker/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/hair-and-body-care/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/health-fitness-care-accessories/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Electronics Pipeline - Group 2 (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/electronics/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/electronics/excel-files"
            )
